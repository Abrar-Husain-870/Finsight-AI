      ...
      <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
        ...
        <div className="flex items-center gap-x-4 lg:gap-x-6">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <div className="h-8 w-8 rounded-full bg-blue-100 dark:bg-blue-900/30 overflow-hidden flex items-center justify-center text-blue-600 dark:text-blue-400 font-semibold text-sm">
            ...
            <AnimatePresence>
              {dropdownOpen && (
                <motion.div
                  ...
                  className="absolute right-0 mt-2 w-56 origin-top-right rounded-xl bg-[var(--color-bg-primary)] border border-[var(--color-border-primary)] shadow-lg ring-1 ring-black/5 focus:outline-none overflow-hidden"
                >
                  ...
                  <div className="py-1">
                    ...
                    >
                      <User className="mr-3 h-4 w-4 text-[var(--color-text-tertiary)] group-hover:text-[var(--color-text-primary)] transition-colors" />
                      Your Profile
                    </Link>
                    <Link
                      to="/settings"
                      ...
                      className="group flex items-center px-4 py-2 text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-bg-secondary)] transition-colors"
                    >
                      <Settings className="mr-3 h-4 w-4 text-[var(--color-text-tertiary)] group-hover:text-[var(--color-text-primary)] transition-colors" />
                      Settings
                    </Link>
                  </div>
